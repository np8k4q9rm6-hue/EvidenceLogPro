...
- Affected app version and iOS version
- Any relevant logs or crash reports (please sanitize)

## Our Commitments
- We will acknowledge receipt within 3 business days.
- We will provide regular status updates.
- We will credit researchers (with permission) in release notes.

## Safe Harbor
We will not pursue legal action for good‑faith, compliant research under this policy. Do not access or modify user data without explicit permission from the owner.

## (Optional) PGP
If you prefer encrypted email, please request our PGP key via email.
